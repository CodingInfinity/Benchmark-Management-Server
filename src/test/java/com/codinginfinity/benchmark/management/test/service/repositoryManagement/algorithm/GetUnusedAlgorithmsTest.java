...
import com.codinginfinity.benchmark.management.test.service.repositoryManagement.GetUnusedRepoEntityTest;
 ...
 */
@Ignore
public class GetUnusedAlgorithmsTest extends GetUnusedRepoEntityTest<AlgorithmCategory, Algorithm,
        AlgorithmRepository,
        AlgorithmManagement> {
    @Override
