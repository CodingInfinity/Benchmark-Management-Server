...
import com.codinginfinity.benchmark.management.test.service.repositoryManagement.DeleteRepoEntityTest;
 ...
 */
public class DeleteAlgorithmTest extends DeleteRepoEntityTest<AlgorithmCategory, Algorithm,
        AlgorithmRepository,
        AlgorithmManagement> {
    @Override
