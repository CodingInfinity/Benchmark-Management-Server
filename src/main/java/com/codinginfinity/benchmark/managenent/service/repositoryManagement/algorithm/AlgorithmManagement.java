...
public interface AlgorithmManagement extends RepositoryEntityManagement<AlgorithmCategory, Algorithm>{
    ...
    @Override
    UpdateRepoEntityMetadataResponse<Algorithm> updateRepoEntityMetaData(UpdataRepoEntityMetadataRequest<AlgorithmCategory, Algorithm> request) throws NonExistentRepoEntityException;
    ...
    @Override
    GetRepoEntityByUsernameResponse<Algorithm> getRepoEntityByUsername(GetRepoEntityByUsernameRequest<Algorithm> request) throws NonExistentRepoEntityException;
