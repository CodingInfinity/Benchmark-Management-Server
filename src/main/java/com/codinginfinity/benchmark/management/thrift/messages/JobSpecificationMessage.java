...
public class JobSpecificationMessage implements org.apache.thrift.TBase<JobSpecificationMessage, JobSpecificationMessage._Fields>, java.io.Serializable, Cloneable, Comparable<JobSpecificationMessage> {
  ...
  static {
    schemes.put(StandardScheme.class, new JobSpecificationMessageStandardSchemeFactory());
    schemes.put(TupleScheme.class, new JobSpecificationMessageTupleSchemeFactory());
  }
  ...
  public int hashCode() {
    ...
    boolean present_languageType = true && (isSetLanguageType());
    list.add(present_languageType);
    if (present_languageType)
      list.add(languageType.getValue());

    boolean present_measurementType = true && (isSetMeasurementType());
    list.add(present_measurementType);
    if (present_measurementType)
      list.add(measurementType.getValue());
    ...
    boolean present_probeInterval = true;
    list.add(present_probeInterval);
    if (present_probeInterval)
      list.add(probeInterval);
  ...
  private static class JobSpecificationMessageStandardScheme extends StandardScheme<JobSpecificationMessage> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, JobSpecificationMessage struct) throws TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 3: // LANGUAGE_TYPE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.languageType = LanguageType.findByValue(iprot.readI32());
          ...
          case 4: // MEASUREMENT_TYPE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.measurementType = MeasurementType.findByValue(iprot.readI32());
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, JobSpecificationMessage struct) throws TException {
      struct.validate();
  ...
  private static class JobSpecificationMessageTupleScheme extends TupleScheme<JobSpecificationMessage> {
    ...
    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, JobSpecificationMessage struct) throws TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, JobSpecificationMessage struct) throws TException {
