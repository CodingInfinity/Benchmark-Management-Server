...
@Generated(value = "Autogenerated by Thrift Compiler (1.0.0-dev)", date = "2016-08-11")
public class Measurement implements org.apache.thrift.TBase<Measurement, Measurement._Fields>, java.io.Serializable, Cloneable, Comparable<Measurement> {
  ...
  private static final SchemeFactory STANDARD_SCHEME_FACTORY = new MeasurementStandardSchemeFactory();
  private static final SchemeFactory TUPLE_SCHEME_FACTORY = new MeasurementTupleSchemeFactory();
