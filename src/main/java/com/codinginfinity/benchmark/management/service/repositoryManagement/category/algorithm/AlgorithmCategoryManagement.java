...
public interface AlgorithmCategoryManagement extends CategoryManagement<AlgorithmCategory> {
    ...
    @Override
    DeleteCategoryResponse<AlgorithmCategory> deleteCategory(DeleteCategoryRequest<AlgorithmCategory> request) throws NonExistentCategoryException, LinkedException;
